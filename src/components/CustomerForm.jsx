                        ...
                        {!isCaseMode && (
                            <div className="grid grid-cols-2 md:grid-cols-3 gap-4">
                                ...
                                <div className="col-span-2 md:col-span-3 flex gap-2 items-end">
                                    <div className="flex-1"><label className="block text-xs font-bold text-gray-500 mb-1">最小坪數</label><input type="number" name="minPing" value={formData.minPing || ''} onChange={handleChange} className="w-full p-2 rounded-lg border dark:bg-slate-800 dark:border-slate-700 dark:text-white" placeholder="Min" /></div>
                                    <span className="mb-3 text-gray-400">~</span>
                                    <div className="flex-1"><label className="block text-xs font-bold text-gray-500 mb-1">最大坪數</label><input type="number" name="maxPing" value={formData.maxPing || ''} onChange={handleChange} className="w-full p-2 rounded-lg border dark:bg-slate-800 dark:border-slate-700 dark:text-white" placeholder="Max" /></div>
                                </div>
