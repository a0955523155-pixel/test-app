...
const DashboardView = ({ 
    ...
    // ★★★ 防呆預設值 (防止白屏的關鍵) ★★★
    const safeStats = dashboardStats || { totalRevenue: 0, counts: { total: 0, won: 0 } };
