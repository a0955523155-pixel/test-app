...
import { 
    ...
    ChevronDown, ChevronUp, Calendar, DollarSign, Edit2 
} from 'lucide-react';
...
const ProjectsPanel = ({ 
    ...
    onManageAd, // 這是開啟新增/編輯 Modal 的函式
    ...
    return (
        <div className="space-y-8 animate-in fade-in slide-in-from-bottom-4">
            ...
            {/* 2. 區域與案場列表 */}
            {Object.entries(companyProjects || {}).map(([region, rawProjects]) => {
                // ★★★ 核心修復：確保 projects 絕對是一個陣列 (避免 .map is not a function) ★★★
